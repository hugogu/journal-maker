<template>
  <div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <NuxtLink to="/admin/systems" class="card hover:shadow-md transition-shadow">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h2 class="text-lg font-semibold">会计体系</h2>
            <p class="text-gray-600 text-sm">管理财报、管报等会计体系</p>
          </div>
        </div>
      </NuxtLink>
    </div>

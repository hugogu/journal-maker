      ...
      <div class="border-b pb-4">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p v-if="sharedData.scenario.description" class="text-gray-600 mt-1">
              {{ sharedData.scenario.description }}
            </p>
          </div>
        ...
        <div class="text-sm text-gray-500 mt-2">分享于 {{ formatDate(sharedData.sharedAt) }}</div>
      </div>

  ...
  <div class="max-w-4xl mx-auto">
    ...
    <form v-else @submit.prevent="saveScenario" class="card space-y-4">
      <div>
        ...
        <input v-model="form.name" type="text" class="input" placeholder="输入场景名称" required />
      </div>
      ...
      <div class="flex items-center gap-2">
        <input v-model="form.isTemplate" type="checkbox" id="isTemplate" class="w-4 h-4" />
      ...
      <div class="flex gap-2 pt-4">
        ...
        <NuxtLink :to="`/scenarios/${scenarioId}`" class="btn-secondary"> 取消 </NuxtLink>
      </div>
    </form>
  </div>
</template>
